...
<head>
  ...
  <title>Jiarong Studios - Contact</title>
  <meta name="description"
    content="Handmade ceramic pieces by Jiarong. Classically trained in Korean wheel throwing, with modern twists in surface applications.">
  <!-- Favicon -->
  ...
  <link href="https://fonts.googleapis.com/css2?family=DM+Mono:ital,wght@0,300;0,400;0,500;1,300;1,400;1,500&family=Fraunces:ital,opsz,wght@0,9..144,100..900;1,9..144,100..900&display=swap" rel="stylesheet">
  <!-- End - Fonts -->
</head>
    ...
    <nav id="nav" x-data="{ open: false }" role="navigation" class="w-full">
      <div class="container mx-auto flex flex-wrap items-center md:flex-no-wrap">
        <div class="mr-4 md:mr-8">
          <a href="../index.html" class="text-2xl font-fraunces font-regular">jiarong studios</a>
        </div>
        ...
        <div id="menu"
          ...
          <ul id="ulMenu"
            ...
            <li class="group transition duration-300">
              <a href="../index.html" class="font-fraunces font-light text-2xl">PORTFOLIO
                <span
                  class="hidden md:block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-black dark:bg-white"></span>
              </a>
            </li>
            <li class="group transition duration-300">
              <a href="about_me.html" class="font-fraunces font-light text-2xl">ABOUT ME
                <span
                  class="hidden md:block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-black dark:bg-white"></span>
              </a>
            </li>
    ...
    <div class="grid grid-cols-2 gap-16">
      ...
      <div class="col-span-2 md:col-span-1 flex relative">
        <div
          ...
          <img
            src="/dist/assets/image8 Large.png"
  ...
  <footer>
    <div class="max-w-screen-xl py-16 mx-auto">
      <div class="grid grid-cols-1 gap-8 text-center mx-auto">
        <div>
          <p class="font-fraunces font-light"><b>jiarong studios</b></p>
          <p class="font-dmmono font-light mt-4 text-sm text-gray-600 dark:text-gray-300">
            Handmade in Seattle WA<br />(469) 605- 1471
          </p>
          <div class="flex mx-auto">
            <div class="mx-auto space-x-6 flex mt-8 text-gray-600 dark:text-gray-300">
              <a class="transition duration-300 hover:opacity-75" href="https://www.instagram.com/byjiarong" target="_blank"
                rel="noreferrer">
